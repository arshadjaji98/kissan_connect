...
class AppLocalizationsUr extends AppLocalizations {
  ...
  @override
  String get critical_growth_stage_guide => 'آپ کی فصل حساس ترقی کے مرحلے میں ہے۔ رہنمائی کے لیے ٹیپ کریں۔';
  ...
  @override
  String get wheat_first_irrigation => 'پہلی آبپاشی: بوائی کے 21-25 دن بعد (کراؤن روٹ)';

  @override
  String get wheat_second_irrigation => 'دوسری آبپاشی: بوائی کے 45-50 دن بعد (ٹیلرنگ)';

  @override
  String get wheat_third_irrigation => 'تیسری آبپاشی: بوائی کے 70-75 دن بعد (جوائنٹنگ)';

  @override
  String get wheat_fourth_irrigation => 'چوتھی آبپاشی: بوائی کے 90-95 دن بعد (پھولنے)';

  @override
  String get wheat_fifth_irrigation => 'پانچویں آبپاشی: بوائی کے 110-115 دن بعد (دانے بھرنا)';

  @override
  String get cotton_first_irrigation => 'پہلی آبپاشی: بوائی کے 30-35 دن بعد';

  @override
  String get cotton_second_irrigation => 'دوسری آبپاشی: اسکوائرنگ مرحلے کے دوران';

  @override
  String get cotton_third_irrigation => 'تیسری آبپاشی: پھولنے کے مرحلے کے دوران';

  @override
  String get cotton_fourth_irrigation => 'چوتھی آبپاشی: بال بننے کے مرحلے کے دوران';

  @override
  String get cotton_fifth_irrigation => 'پانچویں آبپاشی: بال کی نشوونما کے مرحلے کے دوران';

  @override
  String get rice_initial_flooding => 'ابتدائی سیلاب: منتقلی کے بعد 3-5 سینٹی میٹر پانی';

  @override
  String get rice_vegetative_stage => 'نشوونما کے مرحلے: 2-5 سینٹی میٹر پانی برقرار رکھیں';

  @override
  String get rice_reproductive_stage => 'پیداوری مرحلہ: 5-10 سینٹی میٹر پانی برقرار رکھیں';

  @override
  String get rice_ripening_stage => 'پختگی مرحلہ: فصل کی کٹائی سے 2 ہفتے پہلے پانی بتدریج کم کریں';

  @override
  String get corn_first_irrigation => 'پہلی آبپاشی: فوراً بوائی کے بعد';

  @override
  String get corn_second_irrigation => 'دوسری آبپاشی: گھٹنے کی اونچائی مرحلہ (30-45 سینٹی میٹر)';

  @override
  String get corn_third_irrigation => 'تیسری آبپاشی: ٹیسلنگ مرحلہ';

  @override
  String get corn_fourth_irrigation => 'چوتھی آبپاشی: سلکنگ مرحلہ';

  @override
  String get corn_fifth_irrigation => 'پانچویں آبپاشی: دانے بھرنے کا مرحلہ';

  @override
  String get general_rule => 'عام اصول: اوپری 15 سینٹی میٹر مٹی خشک ہونے پر آبپاشی کریں';

  @override
  String get critical_stages => 'اہم مراحل: پھولنے اور پھل لگنے کے دوران مناسب نمی یقینی بنائیں';

  @override
  String get water_quantity => 'پانی کی مقدار: ہر آبپاشی میں 5-7 سینٹی میٹر پانی لگائیں';

  @override
  String get monitoring => 'نگرانی: مٹی کی نمی باقاعدگی سے چیک کریں';

  @override
  String get water_management_tips => '💧 پانی کی دیکھ بھال کے نکات:';

  @override
  String get high_tip_1 => 'مٹی خشک ہو تو فوراً آبپاشی کریں';

  @override
  String get high_tip_2 => 'مٹی کی نمی برقرار رکھنے کے لیے ملچنگ استعمال کریں';

  @override
  String get high_tip_3 => 'موثر آبپاشی کے لیے ڈرپ آبپاشی پر غور کریں';

  @override
  String get high_tip_4 => 'پودوں میں پژمردگی کی علامات دیکھیں';

  @override
  String get high_tip_5 => 'صبح سویرے یا شام کو پانی دیں';

  @override
  String get high_tip_6 => 'مٹی کی نمی روزانہ چیک کریں';

  @override
  String get medium_tip_1 => 'باقاعدہ آبپاشی شیڈول پر عمل کریں';

  @override
  String get medium_tip_2 => 'مٹی کی نمی ہر 2-3 دن چیک کریں';

  @override
  String get medium_tip_3 => 'بارش کی بنیاد پر ایڈجسٹ کریں';

  @override
  String get medium_tip_4 => 'پانی کی بچت کے طریقے استعمال کریں';

  @override
  String get medium_tip_5 => 'موسم کی پیش گوئی پر نظر رکھیں';

  @override
  String get medium_tip_6 => 'آبپاشی کے ریکارڈ رکھیں';

  @override
  String get low_tip_1 => 'اگر بارش متوقع ہو تو آبپاشی مؤخر کریں';

  @override
  String get low_tip_2 => 'پانی دینے سے پہلے مٹی کی نمی چیک کریں';

  @override
  String get low_tip_3 => 'آبپاشی کی تعدد کم کریں';

  @override
  String get low_tip_4 => 'پانی بچانے کے طریقے استعمال کریں';

  @override
  String get low_tip_5 => 'زیادہ پانی دینے کی علامات دیکھیں';

  @override
  String get low_tip_6 => 'ممکن ہو تو بارش کا پانی جمع کریں';
