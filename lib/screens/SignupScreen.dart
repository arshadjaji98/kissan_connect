    ...
    try {
      ...
      Navigator.pushNamedAndRemoveUntil(
        ...
        arguments: {
          ...
          'selectedCrops': _selectedCrops,
          'primaryCrop': _selectedCrops.isNotEmpty ? _selectedCrops.first : 'Wheat',
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                      ...
                      child: Container(
                        ...
                        child: Image.asset(
                          ...
                          errorBuilder: (context, error, stackTrace) {
                            return const Text('KissanConnect Logo', style: TextStyle(fontSize: 24, color: Colors.green));
                          },
                        ),
                      ),
                    ),
                    ...
                    const SizedBox(height: 16),
                    _buildPasswordField(controller: _passwordController, label: 'Password', isObscure: _obscurePassword, onToggle: () => setState(() => _obscurePassword = !_obscurePassword)),
                    const SizedBox(height: 16),
                    _buildPasswordField(controller: _confirmPasswordController, label: 'Confirm Password', isObscure: _obscureConfirmPassword, onToggle: () => setState(() => _obscureConfirmPassword = !_obscureConfirmPassword), isConfirm: true),
                    const SizedBox(height: 16),
                    _buildTextField(controller: _locationController, label: "Your Farm's Location", icon: Icons.location_on_outlined),
                    const SizedBox(height: 16),
                        ...
                        Expanded(
                          ...
                          child: Container(
                            ...
                            child: DropdownButtonFormField<String>(
                              ...
                              items: _landUnits.map((u) => DropdownMenuItem(value: u, child: Text(u))).toList(),
                    ...
                    CropSelectionWidget(
                      onCropsSelected: _onCropsSelected,
                    ),
